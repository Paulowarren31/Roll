...
SECRET_KEY = '1=8!2xl8$q+mm8cecp11$%*r7)e&ii@#xfl(-iw%8r0+pumv00'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['10.80.1.6', '10.80.1.9']
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/paulowar/Roll/templates', os.path.join(BASE_DIR, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
